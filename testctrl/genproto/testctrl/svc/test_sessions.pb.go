...
type Component struct {
	...
	Kind Component_Kind `protobuf:"varint,2,opt,name=kind,proto3,enum=grpc.testing.benchmarking.Component_Kind" json:"kind,omitempty"`
...
type Event struct {
	...
	// The kind of event.
	Kind Event_Kind `protobuf:"varint,2,opt,name=kind,proto3,enum=grpc.testing.benchmarking.Event_Kind" json:"kind,omitempty"`
...
func init() {
	proto.RegisterEnum("grpc.testing.benchmarking.Component_Kind", Component_Kind_name, Component_Kind_value)
	proto.RegisterEnum("grpc.testing.benchmarking.Event_Kind", Event_Kind_name, Event_Kind_value)
	proto.RegisterType((*Component)(nil), "grpc.testing.benchmarking.Component")
	proto.RegisterType((*StartTestSessionRequest)(nil), "grpc.testing.benchmarking.StartTestSessionRequest")
	proto.RegisterType((*TestSessionResults)(nil), "grpc.testing.benchmarking.TestSessionResults")
	proto.RegisterType((*Event)(nil), "grpc.testing.benchmarking.Event")
	proto.RegisterType((*TestSessionMetadata)(nil), "grpc.testing.benchmarking.TestSessionMetadata")
}
...
var fileDescriptor_2673dbce64cc8799 = []byte{
	...
	,
}
...
func (c *testSessionsClient) StartTestSession(ctx context.Context, in *StartTestSessionRequest, opts ...grpc.CallOption) (*longrunning.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.testing.benchmarking.TestSessions/StartTestSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestSessions_StartTestSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.testing.benchmarking.TestSessions/StartTestSession",
	}
...
var _TestSessions_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.testing.benchmarking.TestSessions",
